...
from revizo.models import Subject, Topic, Card  # ✅ Ensure models exist
from revizo.forms import UserForm, UserProfileForm, FlashCardForm  # ✅ Ensure forms exist
...
def user_login(request):
    if request.method == 'POST':
        ...
        if user:
            if user.is_active:
                login(request, user)
                return redirect(reverse('revizo:home'))  # ✅ Fixed redirect
            else:
